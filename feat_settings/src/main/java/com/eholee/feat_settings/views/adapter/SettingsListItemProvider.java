package com.eholee.feat_settings.views.adapter;

import java.util.List;

import com.eholee.feat_settings.settingscategory.SettingsItemFactory;
import com.eholee.feat_settings.datamodel.Category;
...
/**
 * Settings list item provider.
 * You can create different styles of items easily by implement the Category interface. SettingsListItemProvider
 ...
 */
public class SettingsListItemProvider extends RecycleItemProvider implements ListContainer.ItemClickedListener {
     ...
     */
    public SettingsListItemProvider(List<Category> categoryList) {
    ...
    public int getComponentTypeCount() {
        return SettingsItemFactory.TOTAL_ITEM_TYPE;
    }
